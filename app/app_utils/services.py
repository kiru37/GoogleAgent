...
def get_memory_service():
    """Process-wide memory service: Memory Bank (Agent Engine) when configured, else fallback."""
    ...
    agent_engine_id = os.environ.get(
        "GOOGLE_CLOUD_AGENT_ENGINE_ID", "6587864105552445440"
    )
    if agent_engine_id:
        ...
        return VertexAiMemoryBankService(
            project=os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-02-a26999767c1c"),
